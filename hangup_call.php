...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Command to show active channels
    ...
    if ($channel_id !== null) {
        // Command to hang up the call
        $command = 'asterisk -rx "channel request hangup ' . $channel_id . '"';
        ...
        $message = '<div class="message-box success"><i class="bx bx-check-circle"></i> Call hung up successfully on channel: ' . htmlspecialchars($channel_id) . '</div>';
    } else {
        $message = '<div class="message-box error"><i class="bx bx-error"></i> No active call found to hang up.</div>';
    }
}
?>
 ...
 <html lang="en" dir="ltr">
  ...
  -->
    ...
    height: 100vh;
    text-align: center;
    /* background-color: #333; Optional: add background color to body */
}
  ...
  <section class="home-section" >
    ...
    <div class="container">
        ...
        <?php if ($message): ?>
            <?php echo $message; ?>
        <?php endif; ?>
        <a href="demo_call.php" class="button"><i class="bx bx-arrow-back"></i> Back</a>
    </div>
    </main>
