...
<div class="logo-details">
  ...
  <section class="home-section" >
    ...
    <form action="display_trunk.php" method="post">
    <button type="submit">Show SIP Configuration</button>
</form>

    <div class="form-container" style="margin-left:20%;">
        <h1>Chan Mobile Trunk Configuration</h1>
        <form id="trunkForm" action="save_trunk.php" method="POST">
            <label for="type">Type:</label>
            <input type="text" id="type" name="type" required>

            <label for="identifier">Trunk Name:</label>
            <input type="text" id="identifier" name="identifier" required>

            <label for="context">Dialplan Context:</label>
            <input type="text" id="context" name="context" required>

            <label for="dialstring">Custom Setting:</label>
            <input type="text" id="dialstring" name="dialstring" required>

            <input type="submit" value="Save Trunk Configuration">
        </form>
    </div>

    <div id="popup">
        <div class="popup-tick">✔️</div>
        <div class="popup-message">Trunk added successfully.</div>
    </div>
    </main>
